    ...
    <footer className="w-full py-16 bg-black text-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-6">HireMatic</h3>
            <p className="text-gray-400 mb-6">
              Revolutionizing recruitment with AI technology that makes hiring faster, fairer, and more effective.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© {new Date().getFullYear()} HireMatic. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
